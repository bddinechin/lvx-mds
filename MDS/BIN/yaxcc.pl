...
OPTIONS
  ...
  -d Generate a debug parser whose messages are activated by setting env YYDEBUG=1.
...
# Perl source code automatically generated by $progbase $revision.
