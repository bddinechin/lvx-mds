...
my $Bundling_LOG2_MAX = 0;
$Bundling_LOG2_MAX++ while (1 << $Bundling_LOG2_MAX) < $Bundling_COUNT;

print<<"EOT";
#ifndef Bundling_LOG2_MAX
#define Bundling_LOG2_MAX $Bundling_LOG2_MAX
